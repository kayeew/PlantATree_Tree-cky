...
class Cart extends Component {
    ...
    render() {
        ...
        if (this.state.trees !== null)
	      if (!this.state.treeslength)
	        return( 
	        	<div className="treeViewCart">
	        		<h3 className="No-items">No items in the cart. Buy something <Link to="/">here</Link></h3>
	        	</div>
        	);
